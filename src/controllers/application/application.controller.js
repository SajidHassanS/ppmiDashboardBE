...
export async function getAllApplications(req, res) {
    try {
        ...
        return successOkWithData(res, "Projects retrieved successfully", applications);
    } catch (error) {
        return catchError(res, error);
    }
}
...
export async function getApplicationDetails(req, res) {
    try {
        ...
        return successOkWithData(res, "Student retrieved successfully", applications);
    } catch (error) {
        return catchError(res, error);
    }
}
...
export async function applicationStats(req, res) {
    try {
        ...
        const [byProvince, byDistrict, byGender, applicationsByTrade, applicationsBySector] = await Promise.all([
            groupByField("province"),
            groupByField("district"),
            groupByField("gender"),
            groupApplicationsByField("trade"),
            groupApplicationsByField("sector"),
        ]);
